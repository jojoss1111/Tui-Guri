...
int inputs_menu_selector_vertical(Inputs* input, Renderer* r,
    ...
    renderer_add(r, "\033[?25l"); // esconde cursor
...
// Retorna sequência de background num buffer estático rotativo (4 slots)
